...
public class QuestCommandSPHardcore extends QuestCommandBase {
    ...
    public void runCommand(MinecraftServer server, CommandBase command, ICommandSender sender, String[] args) {
        if (!server.isSinglePlayer() || !server.getServerOwner()
            .equalsIgnoreCase(sender.getCommandSenderName())) {
        ...
        sender.addChatMessage(
            new ChatComponentTranslation("betterquesting.cmd.hardcore", new ChatComponentTranslation("options.on")));
