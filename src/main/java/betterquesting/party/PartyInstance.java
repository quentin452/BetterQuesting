...
public class PartyInstance {
	...
	ArrayList<PartyMember> members = new ArrayList<>();
	...
	public static class PartyMember {
		 ...
		 * Operators may not be able to forcibly join parties however they can kick any user without the hosts consent! This power is intentionally reserved for
		 * situations such as forcing a host migration when the user has been offline for an extended period of time.
		 */
