...
public class NetPartyAction {
    ...
    private static void inviteUser(int partyID, String username, long expiry) {
        ...
        if (uuid != null) {
            ...
            BetterQuesting.logger.error("Unable to identify " + username + " to invite to party " + partyID); // No idea
                                                                                                              // who
                                                                                                              // this is
        }
    }
    ...
    private static void kickUser(int partyID, EntityPlayerMP sender, IParty party, String username, int permission) // Is
                                                                                                                    // also
                                                                                                                    // the
                                                                                                                    // leave
                                                                                                                    // action
    ...
    private static int checkPermission(UUID playerID, IParty party) {
        ...
        if (server != null) {
            ...
            if (player != null && server.getConfigurationManager()
                .func_152596_g(player.getGameProfile())) return 4; // Can kick owners or force invites without needing
