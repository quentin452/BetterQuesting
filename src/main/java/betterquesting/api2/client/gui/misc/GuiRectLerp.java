...
public class GuiRectLerp implements IGuiRect {
    ...
    @Override
    public int getX() {
        return isIdle() ? targetRect.getX()
            : (int) Math.round(
                RenderUtils.lerpDouble(
                    (double) startRect.getX(),
    ...
    @Override
    public int getY() {
        return isIdle() ? targetRect.getY()
            : (int) Math.round(
                RenderUtils.lerpDouble(
                    (double) startRect.getY(),
    ...
    @Override
    public int getWidth() {
        return isIdle() ? targetRect.getWidth()
            : (int) Math.round(
                RenderUtils.lerpDouble(
                    (double) startRect.getWidth(),
