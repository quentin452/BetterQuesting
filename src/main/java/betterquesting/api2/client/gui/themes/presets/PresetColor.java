...
public enum PresetColor {
    ...
    public static void registerColors(IThemeRegistry reg) {
        ...
        reg.setDefaultColor(TEXT_HIGHLIGHT.key, new GuiColorStatic(0, 0, 255, 255)); // Selection Highlight (Blue
                                                                                     // Invert)
        reg.setDefaultColor(TEXT_WATERMARK.key, new GuiColorStatic(128, 128, 128, 255)); // Text Field Watermark (Grey
                                                                                         // Text)
