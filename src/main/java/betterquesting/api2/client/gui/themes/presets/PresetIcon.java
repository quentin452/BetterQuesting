...
public enum PresetIcon {
    ...
    ICON_VIEW_MODE_OFF("icon_view_mode_off"),
    ...
    public static final ResourceLocation TX_ICONS = new ResourceLocation(
        BetterQuesting.MODID,
    ...
    public static void registerIcons(IThemeRegistry reg) {
        ...
        reg.setDefaultTexture(
            ICON_VIEW_MODE_OFF.key,
            new SimpleTexture(TX_ICONS, new GuiRectangle(96, 0, 16, 16)).maintainAspect(true));
        reg.setDefaultTexture(
            ICON_VIEW_MODE_ON.key,
            new SimpleTexture(TX_ICONS, new GuiRectangle(96, 0, 16, 16)).maintainAspect(true));
        ...
        reg.setDefaultTexture(
            ICON_QUEST.key,
            new SimpleTexture(TX_ICONS, new GuiRectangle(80, 80, 16, 16)).maintainAspect(true));
