...
public class QuestResourcesFolder implements IResourcePack {
    ...
    public InputStream getInputStream(ResourceLocation location) throws IOException {
        ...
        return new FileInputStream(
            new File(rootFolder.getPath() + "/" + location.getResourceDomain(), location.getResourcePath()));
    }
    ...
    protected void logNameNotLowercase(String name, String file) {
        BetterQuesting.logger
            .log(Level.WARN, "ResourcePack: ignored non-lowercase namespace: {} in {}", new Object[] { name, file });
    }
}
