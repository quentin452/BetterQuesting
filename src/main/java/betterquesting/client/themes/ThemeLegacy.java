...
public class ThemeLegacy implements IGuiTheme {
    ...
    public ThemeLegacy(String name, ResourceLocation texture, ResourceLocation regName) {
        ...
        IGuiTexture qTexNorm = new SlicedTexture(
            texture,
            new GuiRectangle(24, 104, 24, 24),
    ...
    public ThemeLegacy setLineColors(int locked, int incomplete, int complete) {
        ...
        COLOR_MAP
            .put(PresetColor.QUEST_LINE_UNLOCKED.getKey(), new GuiColorPulse(incomplete, darkenColor(locked), 1F, 0F));
        COLOR_MAP
            .put(PresetColor.QUEST_LINE_PENDING.getKey(), new GuiColorPulse(complete, darkenColor(locked), 1F, 0F));
        COLOR_MAP
            .put(PresetColor.QUEST_LINE_COMPLETE.getKey(), new GuiColorPulse(complete, darkenColor(locked), 1F, 0F));
        return this;
    }
    ...
    public ThemeLegacy setIconColors(int locked, int incomplete, int pending, int complete) {
        ...
        COLOR_MAP
            .put(PresetColor.QUEST_ICON_UNLOCKED.getKey(), new GuiColorPulse(incomplete, darkenColor(locked), 1F, 0F));
        COLOR_MAP.put(PresetColor.QUEST_ICON_PENDING.getKey(), new GuiColorPulse(pending, darkenColor(locked), 1F, 0F));
        COLOR_MAP
            .put(PresetColor.QUEST_ICON_COMPLETE.getKey(), new GuiColorPulse(complete, darkenColor(locked), 1F, 0F));
        COLOR_MAP
            .put(PresetColor.QUEST_ICON_REPEATABLE.getKey(), new GuiColorPulse(complete, darkenColor(locked), 1F, 0F));
        return this;
    }
