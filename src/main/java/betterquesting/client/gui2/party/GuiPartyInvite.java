...
public class GuiPartyInvite extends GuiScreenCanvas implements IPEventListener {
    ...
    public void initPanel() {
        ...
        scNameScroll.getTransform()
            .setParent(cvNameList.getTransform());
        cvNameList.setScrollDriverY(scNameScroll);

        int listWidth = cvBackground.getTransform()
            .getWidth() - 64;
        ...
        for (int i = 0; i < nameList.size(); i++) {
            ...
            PanelButtonStorage<String> btnName = new PanelButtonStorage<>(
                new GuiRectangle(x1 * nameSize, y1 * 16, nameSize, 16),
                2,
                name,
                name);
        ...
        scNameScroll.setActive(
            cvNameList.getScrollBounds()
                .getHeight() > 0);
    }
