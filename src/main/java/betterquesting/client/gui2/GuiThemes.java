...
public class GuiThemes extends GuiScreenCanvas {
    ...
    public void initPanel() {
        ...
        PanelButton btnExit = new PanelButton(
            new GuiTransform(GuiAlign.BOTTOM_CENTER, new GuiPadding(-100, -16, -100, 0), 0),
            0,
            QuestTranslation.translate("gui.done"));
        btnExit
            .setClickAction((b) -> mc.displayGuiScreen(ThemeRegistry.INSTANCE.getGui(PresetGUIs.HOME, GArgsNone.NONE)));
        ...
        int width = canScroll.getTransform()
            .getWidth();
        ...
        for (int i = 0; i < themes.size(); i++) {
            ...
            PanelButtonStorage<ResourceLocation> pbs = new PanelButtonStorage<>(
                trans,
                -1,
                theme.getName(),
                theme.getID());
        ...
        inCan.addPanel(vsb);
        vsb.getTransform()
            .setParent(canScroll.getTransform());
        ...
        preCanIn0.addPanel(
            new PanelTextBox(new GuiTransform(GuiAlign.MID_CENTER, -32, -8, 64, 16, 0), "EXAMPLE").setAlignment(1)
        ...
        IGuiTexture icoSlides = new SlideShowTexture(
            1F,
            ...
            new GuiTextureColored(
                PresetTexture.QUEST_NORM_4.getTexture(),
            ...
            new GuiTextureColored(
                PresetTexture.QUEST_MAIN_4.getTexture(),
                PresetColor.QUEST_ICON_REPEATABLE.getColor()),
        ...
        PanelGeneric pqp = new PanelGeneric(
            new GuiTransform(new Vector4f(0.25F, 0.5F, 0.25F, 0.5F), -12, -12, 24, 24, 0),
            icoSlides);
        ...
        itemFrame.addPanel(
            new PanelGeneric(
                new GuiTransform(GuiAlign.FULL_BOX, new GuiPadding(1, 1, 1, 1), 0),
                new ItemTexture(new BigItemStack(BetterQuesting.guideBook, 9999, 0), true, true)));

        IGuiLine linSeq = new GuiLineSequence(
            1F,
        ...
        IGuiColor colSeq = new GuiColorSequence(
            1F,
