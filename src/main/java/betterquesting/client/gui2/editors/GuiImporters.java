...
public class GuiImporters extends GuiScreenCanvas implements IPEventListener, ICallback<File[]> {
    ...
    public void initPanel() {
        ...
        int width = cvImports.getTransform()
            .getWidth();
        ...
        for (int i = 0; i < impList.size(); i++) {
            ...
            cvImports.addPanel(
                new PanelButtonStorage<>(
                    new GuiRectangle(0, i * 16, width, 16, 0),
                    1,
        ...
        scReq.getTransform()
            .setParent(cvImports.getTransform());
