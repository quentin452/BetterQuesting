...
public class GuiQuesting extends GuiScreen implements GuiYesNoCallback {
	...
	private static GuiQuesting lastScreen;
	...
	public void drawScreen(int mx, int my, float partialTick) {
		...
		this.fontRendererObj.drawString(EnumChatFormatting.BOLD + tmp, this.guiLeft + (sizeX / 2) - this.fontRendererObj.getStringWidth(tmp) / 2, this.guiTop + 18,
	...
	protected void switchToParentScreen() {
		if (parent instanceof GuiQuesting) {
			switchScreen((GuiQuesting) parent);
		} else {
			mc.displayGuiScreen(parent);
		}
	}

	protected void switchScreen(GuiQuesting screen) {
	...
	public static GuiQuesting getLastScreen() {
		return lastScreen;
	}
}
