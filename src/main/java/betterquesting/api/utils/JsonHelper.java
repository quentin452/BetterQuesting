...
public class JsonHelper {
    ...
    public static ArrayList<JsonElement> GetUnderlyingArray(JsonArray array) {
        try {
            ...
            QuestingAPI.getLogger()
                .log(Level.ERROR, "Unable to retrieve underlying JsonArray:", e);
        }
    ...
    public static Future<Void> WriteToFile2(File file, JsonObject jObj) {
        ...
        return BQThreadedIO.DISK_IO.enqueue(() -> {
            ...
            try (FileOutputStream fos = new FileOutputStream(tmp);
                ...
                QuestingAPI.getLogger()
                    .error("An error occurred while saving JSON to file (File write):", e);
                return null;
            }
            ...
            try (FileInputStream fis = new FileInputStream(tmp);
                ...
                QuestingAPI.getLogger()
                    .error("An error occurred while saving JSON to file (Validation check):", e);
                return null;
            }
    ...
    public static void CopyPaste(File fileIn, File fileOut) {
        ...
        try {
            ...
            QuestingAPI.getLogger()
                .log(Level.ERROR, "Failed copy paste", e);
        }
    }
    ...
    public static boolean isFluid(NBTTagCompound json) {
        return json != null && json.hasKey("FluidName", 8)
    ...
    public static BigItemStack JsonToItemStack(@Nonnull NBTTagCompound nbt) {
        ...
        return PlaceholderConverter.convertItem(
            preCheck,
            idName,
